...
public class signUpDriverPage1 extends AppCompatActivity {
    //variable
    ImageView back_btn;
    Button next;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sign_up_driver_page1);
        //Hooks
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(signUpDriverPage1.this,CapitainLogin.class);
    ...
    public void nextSignUp1(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), signUpDriverPage2.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        UserHelper user = new UserHelper(fullName_str,email_str,username_str,password_str);
        //add transition
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(signUpDriverPage1.this, pairs);
