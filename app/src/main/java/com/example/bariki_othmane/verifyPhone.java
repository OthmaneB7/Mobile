...
public class verifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserHelperCo user = (UserHelperCo) getIntent().getSerializableExtra("EXTRA_USER3");
                ...
                .addOnCompleteListener(verifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            intent.putExtra("caller","verifyPhone");
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK| Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent);
                        }
                        else {
                            Toast.makeText(verifyPhone.this,task.getException().getMessage(), Toast.LENGTH_SHORT)
                                    .show();
    ...
    public void return_to_first_step(View view) {
        Intent intent = new Intent(verifyPhone.this,signUpPage1.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
    }
}
